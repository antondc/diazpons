<?php
    ...
    define( 'K_DB_NAME', 'diazpons' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'diazpons' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'asf8ygef' );
    // 7.
    ...
    define( 'K_PAYPAL_USE_SANDBOX', 0 );
    // 18.
    // Email address of your PayPal 'business' account selling the item
    define( 'K_PAYPAL_EMAIL', 'info@diazpons.com' );
    // 19.
