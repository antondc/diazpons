...
use crate::infrastructure::http::routes::{authors, book, books, catchers, home};
...
pub async fn main() {
  ...
  let _ = rocket::custom(&config)
    .mount("/", routes![home::home_route, book::book_route, books::books_route, authors::authors_route])
